...
# particle 0 is at 0
# particle 1 has -1mm offset
dx[1] = -0.001

# particle 2 travels straight but at pt = 1.0e-2
dpt[2] = 1.0e-2

# particle 3 has 1 mm y offset
dy[3] = 0.001

# particle 4 same offset as particle 3 but at pt of 1.0e-2
dy[4] = 0.001
dpt[4] = 1.0e-2
...
sim.lattice.extend(
    [
        monitor,
        elements.ChrQuad(name="toyquad", ds=1.0, k=1.0/(1.0*10.0), nslice=1),
        monitor,
    ]
)
